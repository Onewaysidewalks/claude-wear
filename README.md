...
are in [PLAN.md](PLAN.md). The testing matrix (home, cellular, Wi-Fi away, LTE away) is in
...
APKs land in `android/*/build/outputs/apk/`. `make` at the top level runs all of it.
